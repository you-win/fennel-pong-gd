package.preload["fennel.binary"] = package.preload["fennel.binary"] or function(...)
  ...
  local function compile_binary(lua_c_path, executable_name, static_lua, lua_include_dir, native)
	...
	local _1_
	do
	  local _0_0 = shellout((cc .. " -dumpmachine"))
	  if _0_0 then
		_1_ = _0_0:match("mingw")
	  else
		_1_ = _0_0
	  end
	end
...
local function dosafely(f, ...)
  ...
  _0_0, _1_0 = xpcall(_2_, fennel.traceback)
  if ((_0_0 == true) and (nil ~= _1_0)) then
	local val = _1_0
	return val
  elseif (true and (nil ~= _1_0)) then
	local _ = _0_0
	local msg = _1_0
...
local function compile(files)
  for _, filename in ipairs(files) do
	...
	do
	  ...
	  _2_0, _3_0 = xpcall(_4_, fennel.traceback)
	  if ((_2_0 == true) and (nil ~= _3_0)) then
		local val = _3_0
		print(val)
	  elseif (true and (nil ~= _3_0)) then
		local _0 = _2_0
		local msg = _3_0
		do end (io.stderr):write((msg .. "\n"))
		os.exit(1)
...
elseif ((type(_1_0) == "table") and (_1_0[1] == "-c")) then
  local files = {select(2, (_G.unpack or table.unpack)(_1_0))}
  return compile(files)
...
elseif ((type(_1_0) == "table") and (_1_0[1] == "-e") and (nil ~= _1_0[2])) then
  ...
  do
	local a = _1_0[1]
	_5_ = (((type(_1_0) == "table") and (nil ~= _1_0[1])) and ((a == "-v") or (a == "--version")))
  end
  if _5_ then
	local a = _1_0[1]
